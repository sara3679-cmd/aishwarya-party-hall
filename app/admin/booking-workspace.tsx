...
export function BookingWorkspace({ view = "dashboard" }: { view?: "dashboard" | "manager" | "form" }) {
  ...
  if (view === "dashboard") return <main className="adminPage adminDashboardPage">
    ...
    <section className="adminDashboardGroups">
      <article className="adminDashboardGroup partyHallDashboard"><p className="kicker">Aishwarya Party Hall</p><h2>Booking Administration</h2><div className="dashboardLinkGrid">{staff.role === "admin" && <a className="primaryDashboardLink" href="/admin/bookings/new"><b>Hall Booking</b><span>Create a new confirmed hall booking</span></a>}{staff.role === "admin" && <a href="/admin/greetings"><b>Customer Greetings &amp; Advertisements</b><span>Prepare, approve and track messages for past and present customers</span></a>}<a href="/admin/bookings"><b>Booking Manager</b><span>View, edit and manage confirmed bookings</span></a>{staff.role === "admin" && <a href="/admin/financial"><b>New Expenses &amp; Revenue</b><span>Add booking expenses and additional revenue</span></a>}{staff.role === "admin" && <a href="/admin/reports/bookings"><b>Booking Expenses &amp; Revenue</b><span>Booking expenses and revenue</span></a>}{staff.role === "admin" && <a href="/admin/financial/profit-loss"><b>Profit &amp; Loss Summary</b><span>Monthly and yearly profit or loss</span></a>}<a href="/admin/cctv"><b>Live CCTV</b><span>Staff-only camera dashboard</span></a></div></article>
