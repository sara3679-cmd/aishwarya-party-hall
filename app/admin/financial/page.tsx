...
export default function FinancialReportPage() {
  ...
  const [additionalRevenueFilter, setAdditionalRevenueFilter] = useState("");
  ...
  const filteredIncome = useMemo(() => {
    const query = additionalRevenueFilter.trim().toLowerCase();
  ...
  }, [income, additionalRevenueFilter]);
