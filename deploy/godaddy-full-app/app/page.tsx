...
const galleries = {
  ...
  Korattur: [
    ...
    ["/images/korattur/dining-1.jpg", "Korattur screen-partitioned dining area"],
...
const WHATSAPP = "https://wa.me/919884806618?text=Hello%20Aishwarya%20Party%20Hall%2C%20I%20would%20like%20to%20check%20availability.";
    ...
    <main>
      <header className="siteHeader">
        ...
        <nav className={menuOpen ? "open" : ""} aria-label="Main navigation">
          ...
          <a href="/cctv" onClick={() => setMenuOpen(false)}>Live CCTV Login</a><a href="/admin" onClick={() => setMenuOpen(false)}>Admin</a>
        </nav>
      ...
      <section className="hero" id="home">
        ...
        <div className="heroContent">
          ...
          <div className="heroActions"><a className="goldButton" href="#enquiry">Availability Calendar</a><a className="ghostButton" href="#locations">Explore our halls</a></div>
        </div>
      ...
      <section className="locations sectionPad" id="locations">
        ...
        <div className="locationCards">
          <article className="locationCard"><div className="locationPhoto"><img src="/images/padi/exterior.jpg" alt="Aishwarya Party Hall Padi exterior"/><span>PADI</span></div><div className="locationBody"><p className="cardLabel">Aishwarya Party Hall · Padi</p><h3>A warm, intimate hall<br/>for meaningful occasions.</h3><div className="hallPackage"><b>₹21,000</b><span>5-hour hall rental · 150–200 guests</span><strong>Stage decoration extra · Balance due 2 days before</strong></div><address className="venueAddress"><span className="addressPin" aria-hidden="true">●</span><span><b>Visit us in Padi</b>No. 11, Elango Nagar Main Road<br/>Officers Colony, Chennai – 600050</span></address><ul><li>Air-conditioned hall, stage & separate dining</li><li>Music system, power backup & dressing room</li><li>EB charges and cleaning included</li><li>Outside parking; outside catering allowed</li><li>₹5,000 non-refundable booking advance</li></ul><div className="contactButtons"><a href="tel:+919884806618">Call 98848 06618</a></div><a className="mapCard" href={MAPS.Padi} target="_blank" rel="noreferrer"><img src="/images/pamphlets/aishwarya-party-hall-padi-maps-qr.png" alt="QR code for Aishwarya Party Hall Padi directions"/><span><b>Find Padi on Google Maps</b><small>Scan the QR code for directions and reviews</small></span><i>↗</i></a><p className="secondPhone">Alternate: <a href="tel:+919884806629">98848 06629</a></p></div></article>
          <article className="locationCard"><div className="locationPhoto"><img src="/images/korattur/exterior-1.jpg" alt="Aishwarya Party Hall Korattur exterior"/><span>KORATTUR</span></div><div className="locationBody"><p className="cardLabel">Aishwarya Party Hall · Korattur</p><h3>A spacious modern venue<br/>with convenient facilities.</h3><div className="hallPackage"><b>₹17,000</b><span>5-hour hall rental · up to 150 guests</span><strong><span>· EB ₹20 per unit</span><span>· Stage decoration extra</span><span>· 1-hour power backup available for ₹1,500</span></strong></div><address className="venueAddress"><span className="addressPin" aria-hidden="true">●</span><span><b>Visit us in Korattur</b>322, Station Road<br/>Korattur, Chennai – 600080</span></address><ul><li>Dining area within the hall, divided by a screen</li><li>Lift access, dressing room and cleaning</li><li>Covered and outside parking</li><li>Outside catering allowed</li><li>₹5,000 non-refundable booking advance</li></ul><div className="contactButtons"><a href="tel:+919884806618">Call 98848 06618</a></div><a className="mapCard" href={MAPS.Korattur} target="_blank" rel="noreferrer"><img src="/images/pamphlets/aishwarya-party-hall-korattur-maps-qr.png" alt="QR code for Aishwarya Party Hall Korattur directions"/><span><b>Find Korattur on Google Maps</b><small>Scan the QR code for directions and reviews</small></span><i>↗</i></a><p className="secondPhone">Alternate: <a href="tel:+919884806608">98848 06608</a></p></div></article>
        </div>
      </section>
      ...
      <section className="planning sectionPad" id="planning">
        <div><p className="kicker">Plan with confidence</p><h2>Clear answers before<br/><em>you celebrate.</em></h2><p>Hall capacity, decoration options, catering packages and pricing depend on your location, function and guest count. Call or WhatsApp us for a suitable quotation.</p><a className="maroonButton" href={WHATSAPP} target="_blank" rel="noreferrer">Ask on WhatsApp <span>→</span></a></div>
        <div className="faqList">
          <details><summary>How do I confirm a booking?</summary><p>Check the calendar, then contact our team. A booking is confirmed only after availability and advance payment are verified.</p></details>
          <details><summary>Are vegetarian and non-vegetarian menus available?</summary><p>Yes. SS Foods Catering Service provides both vegetarian and non-vegetarian menus.</p></details>
          <details><summary>Can I change or cancel a date?</summary><p>Please call our team. Rescheduling, cancellation and advance-payment terms depend on the confirmed booking.</p></details>
          <details><summary>How do I know the capacity and price?</summary><p>Capacity and pricing vary by hall, function setup and guest count. Contact us for accurate current details.</p></details>
        </div>
      </section>
      ...
      <footer><div className="footerTop"><a className="brand footerBrand" href="#home"><img src="/images/brand/aishwarya-party-hall-logo.jpg" alt="Aishwarya Party Hall" /></a><p>Beautiful halls. Delicious food.<br/>Warm celebrations.</p></div><div className="footerLinks"><div><b>Padi</b><address>No. 11, Elango Nagar Main Road<br/>Officers Colony, Chennai – 600050</address><a href="tel:+919884806618">98848 06618</a><a href="tel:+919884806629">98848 06629</a><a href={MAPS.Padi} target="_blank" rel="noreferrer">Google Maps ↗</a></div><div><b>Korattur</b><address>322, Station Road<br/>Korattur, Chennai – 600080</address><a href="tel:+919884806618">98848 06618</a><a href="tel:+919884806608">98848 06608</a><a href={MAPS.Korattur} target="_blank" rel="noreferrer">Google Maps ↗</a></div><div><b>Explore & Follow</b><a href="#gallery">Gallery</a><a href="/catering">SS Foods Catering</a><a href="/admin/catering-menu">SS FOODS Admin</a><a href="https://www.facebook.com/people/Aishwarya-Party-Hall/61551992819852/" target="_blank" rel="noreferrer">Facebook ↗</a><a href="https://www.instagram.com/aishwarya_party_hall/" target="_blank" rel="noreferrer">Instagram ↗</a><a href="#enquiry">Availability calendar</a><a href="/privacy">Privacy policy</a><a className="adminFooterLink" href="/admin">Admin Login →</a></div></div><div className="footerBottom"><small>© 2026 Aishwarya Party Hall. All rights reserved.</small><small>Padi · Korattur · Chennai</small></div></footer>

      <div className="floatingActions">
        <a className="availabilityButton" href="#enquiry" aria-label="Open availability calendar">Availability Calendar</a>
        <a className="whatsappButton" href={WHATSAPP} target="_blank" rel="noreferrer" aria-label="Contact Aishwarya Party Hall on WhatsApp">WhatsApp</a>
      </div>
